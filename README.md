...
2. As a new visitor, I would like to know about the menu items and the price list.
...
* #### Gallery page
    ...
    * Every image will be displayed on a block level on mobile devices for responsiveness reasons.
